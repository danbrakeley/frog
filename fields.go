...
func Time(name string, value time.Time) FieldTimeFormat {
	return FieldTimeFormat{Key: name, Value: value, Format: time.RFC3339}
}
...
func TimeNano(name string, value time.Time) FieldTimeFormat {
	return FieldTimeFormat{Key: name, Value: value, Format: time.RFC3339Nano}
}
...
func TimeUnix(name string, value time.Time) FieldTimeUnix {
	return FieldTimeUnix{Key: name, Value: value}
}
...
func TimeUnixNano(name string, value time.Time) FieldTimeUnix {
	return FieldTimeUnix{Key: name, Value: value, Nano: true}
}
...
func Uint64(name string, value uint64) FieldUint64 {
	return FieldUint64{Key: name, Value: value}
}
...
func (f FieldBool) Field() (string, string) {
	if f.Value {
		return f.Key, "true"
	}
	return f.Key, "false"
...
func (f FieldDuration) Field() (string, string) {
...
func (f FieldError) Field() (string, string) {
...
func (f FieldFloat64) Field() (string, string) {
	return f.Key, fmt.Sprintf("%g", f.Value)
}
...
func (f FieldInt64) Field() (string, string) {
	return f.Key, strconv.FormatInt(f.Value, 10)
}
...
func (f FieldString) Field() (string, string) {
	return f.Key, "\"" + escapeStringForJSON(f.Value) + "\""
}
...
func (f FieldTimeFormat) Field() (string, string) {
	return f.Key, "\"" + f.Value.Format(f.Format) + "\""
}
...
func (f FieldTimeUnix) Field() (string, string) {
	if f.Nano {
		return f.Key, strconv.FormatInt(f.Value.UnixNano(), 10)
	}
	return f.Key, strconv.FormatInt(f.Value.Unix(), 10)
}
...
func (f FieldUint64) Field() (string, string) {
	return f.Key, strconv.FormatUint(f.Value, 10)
}
